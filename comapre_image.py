...
async def create_masked_showcase(uid, uid2):
    ...
    # 1. Draw UI Rectangles onto the UI Layer first
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # 3. Paste Characters ONTO UI_LAYER (This fixes the layering issue)
        for u_idx, current_uid in enumerate([uid2, uid]):
            ...
            for i, char in enumerate(char_list):
                ...
                if char_img:
                    ...
                    # Paste to ui_layer so it's above the rounded_rectangle
